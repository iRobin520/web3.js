 ...
 */
var ATokenBNBProvider = function ATokenBNBProvider(host, options) {
    options = options || {};
...
ATokenBNBProvider.prototype.setConfig = function(config){
    this.address = config.address;
    this.chainId = config.chainId;
}

ATokenBNBProvider.prototype.setAddress = function(address){
    this.address = address;
    this.ready = !!address;
}

ATokenBNBProvider.prototype.enable = function(){
    var _this = this;
    var payload = {
        jsonrpc: '2.0',
        id: 999999999,
...
ATokenBNBProvider.prototype.sendResponse = function(msgId,address) {
    //Empty implementation
}

ATokenBNBProvider.prototype.on = function() {
    //Empty implementation
}

ATokenBNBProvider.prototype.isAToken = function() {
   return true;
}

ATokenBNBProvider.prototype.isMetaMask = function() {
    return true;
}

ATokenBNBProvider.prototype._prepareRequest = function(){
    var request;
 ...
 */
ATokenBNBProvider.prototype.send = function (payload, callback) {
    var _this = this;
    var request = this._prepareRequest();

    //Call native app method
    var callNativeMethod = function (method,id,params) {
        let methodName = 'bnb.' + method;
        var parameters = {};
 ...
 * @returns {boolean}
 */
ATokenBNBProvider.prototype.supportsSubscriptions = function () {
    return false;
};

module.exports = ATokenBNBProvider;
