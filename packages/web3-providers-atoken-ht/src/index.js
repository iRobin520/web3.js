...
/**
 * ATokenHTProvider should be used to send rpc calls over http
 */
var ATokenHTProvider = function ATokenHTProvider(host, options) {
    options = options || {};
...
ATokenHTProvider.prototype.setConfig = function(config){
    this.address = config.address;
    this.chainId = config.chainId;
}

ATokenHTProvider.prototype.setAddress = function(address){
    this.address = address;
    this.ready = !!address;
}

ATokenHTProvider.prototype.enable = function(){
    var _this = this;
    var payload = {
        jsonrpc: '2.0',
        id: 999999999,
...
ATokenHTProvider.prototype.sendResponse = function(msgId,address) {
    //Empty implementation
}

ATokenHTProvider.prototype.on = function() {
    //Empty implementation
}

ATokenHTProvider.prototype.isAToken = function() {
   return true;
}

ATokenHTProvider.prototype.isMetaMask = function() {
    return true;
}

ATokenHTProvider.prototype._prepareRequest = function(){
    var request;
 ...
 */
ATokenHTProvider.prototype.send = function (payload, callback) {
    var _this = this;
    var request = this._prepareRequest();

    //Call native app method
    var callNativeMethod = function (method,id,params) {
        let methodName = 'ht.' + method;
        var parameters = {};
...
ATokenHTProvider.prototype.request = function (data) {
    var _this = this;
    if (window.ethereum) {
...
ATokenHTProvider.prototype.disconnect = function () {
    //NO OP
};
 ...
 * @returns {boolean}
 */
ATokenHTProvider.prototype.supportsSubscriptions = function () {
    return false;
};

module.exports = ATokenHTProvider;
